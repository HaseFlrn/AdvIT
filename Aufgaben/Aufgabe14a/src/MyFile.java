...
public class MyFile {
	...
	public static void write(String filename, int line_no, String data)throws IOException {
		line_no--;
		String[] fileData = new String[(getLastLine(filename) > line_no) ? getLastLine(filename) : line_no ];
